...
¡Es importante que trás editar_config.yml ó subir una imagen, se haga un *Commit changes* para guardar los cambios, sino no se actualizará. Para ello en la parte inferior disponemos del siguiente botón. 
